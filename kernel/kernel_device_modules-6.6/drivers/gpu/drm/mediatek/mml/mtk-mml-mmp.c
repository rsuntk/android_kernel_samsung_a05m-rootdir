...
void mml_mmp_init(void)
{
	...
	mml_mmp_events.m2m_submit_done = mmprofile_register_event(parent, "m2m_submit_done");
	mml_mmp_events.m2m_sig = mmprofile_register_event(parent, "m2m_sig");
	mml_mmp_events.m2m_process_done = mmprofile_register_event(parent, "m2m_process_done");
